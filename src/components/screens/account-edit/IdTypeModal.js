            ...
            <View style={[tw`flex-1 items-center justify-center`, {backgroundColor: 'rgba(0, 0, 0, 0.5)'}]}>
                <View style={[tw`bg-white rounded p-3`, {width: 300, top: 20}]}>
                    ...
                    <TouchableOpacity
                        ...
                        onPress={() => {
                            setInitValues({...copyValues, idType: 'Cédula', identification: ''});
                            setSwitchIcon(!switchIcon);
                            setVisible(false);
                            setResetValues(true);
                        }}
                    ...
                    <TouchableOpacity
                        style={tw`w-full p-2 border-b border-slate-100 flex-row items-center`}
                        onPress={() => {
                            setInitValues({...copyValues, idType: 'Pasaporte', identification: ''});
                            setSwitchIcon(!switchIcon);
                            setVisible(false);
                            setResetValues(true);
                        }}
                    ...
                    <TouchableOpacity
                        style={tw`w-full p-2 border-b border-slate-100 flex-row items-center`}
                        onPress={() => {
                            setInitValues({...copyValues, idType: 'Carnet de extranjeria', identification: ''});
                            setSwitchIcon(!switchIcon);
                            setVisible(false);
                            setResetValues(true);
                        }}
                    ...
                    <TouchableOpacity
                        style={tw`w-full p-2 border-b border-slate-100 flex-row items-center`}
                        onPress={() => {
                            setInitValues({...copyValues, idType: 'RUC', identification: ''});
                            setSwitchIcon(!switchIcon);
                            setVisible(false);
                            setResetValues(true);
                        }}
                    ...
                    <TouchableOpacity
                        style={tw`w-full p-2 border-b border-slate-100 flex-row items-center`}
                        onPress={() => {
                            setInitValues({...copyValues, idType: 'Otros', identification: ''});
                            setSwitchIcon(!switchIcon);
                            setVisible(false);
                            setResetValues(true);
                        }}
