...
function PendingPayments() {
    ...
    const {pendingPayments, userData, headers} = dataStore;
    ...
    return (
        <View style={tw`flex-1 bg-white`}>
            ...
            <View style={tw`flex-1 p-3`}>
                <Text style={tw`font-bold text-base text-blue-500`}>PAGOS PENDIENTES</Text>
                ...
                {pendingPayments?.length === 0 && <NoData/>}
...
export default observer(PendingPayments);
